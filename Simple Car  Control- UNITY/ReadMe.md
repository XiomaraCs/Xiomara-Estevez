A simple demonstartion game using Unity to showcase basic car driving mechanics. Build is not a complete open-world, simply to 
demonstarte how the car is suppossed to move if building a simple crash/obstacle game.

Car moves forward, backwards, turns.

Link to Unity Play to test game:
Instruction:
